...
try {
	...
	var conf = {
		attachmentsBasePath: "/mnt/equelladata01/Institutions/cca2012/Attachments", /** No trailing slash */
		...
		javaPathToFileLister: "/Users/ephetteplace/FileLister20180730.jar",
...
function listFCOs(useStaging) {
	...
	if(rsp.getCode() == 0) {
		...
		// skip to just the valid JSON output of FileLister jar
		fileListing = fileListing.substring(fileListing.indexOf("{"));
